    ...
    public void generate() {
        ...
        addBoss("overworld/wolf", b -> b
            ...
            .stats(rare, c -> c
                ...
                .modifier(Attributes.MAX_HEALTH, Operation.ADD_MULTIPLIED_BASE, 1.0F, 2.0F)
            ...
            .stats(epic, c -> c
                ...
                .enchLevels(35, 25)
                .effect(1, MobEffects.FIRE_RESISTANCE)
                .modifier(Attributes.MAX_HEALTH, Operation.ADD_MULTIPLIED_BASE, 1.5F, 3.0F)
            ...
            .stats(mythic, c -> c
                ...
                .enchLevels(35, 25)
                .effect(1, MobEffects.FIRE_RESISTANCE)
                .modifier(Attributes.MAX_HEALTH, Operation.ADD_MULTIPLIED_BASE, 2.0F, 4.0F)
    ...
    protected static Invader.Builder basicMeleeStats(Invader.Builder builder) {
        ...
        return builder
            .stats(uncommon, c -> c
                ...
                .enchLevels(20, 12)
                .effect(1, MobEffects.FIRE_RESISTANCE)
                .modifier(Attributes.MAX_HEALTH, Operation.ADD_MULTIPLIED_BASE, 0.5F, 1.5F)

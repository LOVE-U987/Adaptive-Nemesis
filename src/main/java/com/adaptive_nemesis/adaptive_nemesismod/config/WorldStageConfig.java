...
public class WorldStageConfig {
    ...
    * 是否启用世界阶段系统
    */
    public final ForgeConfigSpec.BooleanValue ENABLE_WORLD_STAGE;

    /**
    * 每个世界阶段的难度倍率增量
    */
    public final ForgeConfigSpec.DoubleValue WORLD_STAGE_MULTIPLIER_PER_STAGE;

    /**
    * 最大世界阶段数
    */
    public final ForgeConfigSpec.IntValue WORLD_STAGE_MAX_STAGE;

    public WorldStageConfig(ForgeConfigSpec.Builder builder) {

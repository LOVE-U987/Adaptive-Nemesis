...
public class RandomDistributionConfig {
    ...
    * 是否启用属性随机分布
    */
    public final ForgeConfigSpec.BooleanValue ENABLE_RANDOM_DISTRIBUTION;

    /**
    * 随机分布最小因子 (0.7 = 70%)
    */
    public final ForgeConfigSpec.DoubleValue RANDOM_MIN_FACTOR;

    /**
    * 随机分布最大因子 (1.3 = 130%)
    */
    public final ForgeConfigSpec.DoubleValue RANDOM_MAX_FACTOR;

    /**
    * 是否固定速度加成为0
    */
    public final ForgeConfigSpec.BooleanValue FIX_SPEED_BONUS_TO_ZERO;

    public RandomDistributionConfig(ForgeConfigSpec.Builder builder) {

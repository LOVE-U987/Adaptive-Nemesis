...
public class DifficultySmoothingConfig {
    ...
    * 是否启用难度缓动
    */
    public final ModConfigSpec.BooleanValue ENABLE_DIFFICULTY_SMOOTHING;

    /**
    * 难度缓动因子 (0.0-1.0)，越大越快对齐
    */
    public final ModConfigSpec.DoubleValue DIFFICULTY_SMOOTHING_FACTOR;

    /**
    * 难度缓动更新间隔（tick数，20tick=1秒）
    */
    public final ModConfigSpec.IntValue DIFFICULTY_SMOOTHING_TICK_INTERVAL;

    public DifficultySmoothingConfig(ModConfigSpec.Builder builder) {

...
public class WeaponDamageCapConfig {
    ...
    * 武器伤害基础上限
    */
    public final ForgeConfigSpec.DoubleValue WEAPON_DAMAGE_BASE_CAP;

    /**
    * 每单位难度倍率增加的伤害上限
    */
    public final ForgeConfigSpec.DoubleValue WEAPON_DAMAGE_CAP_PER_DIFFICULTY;

    /**
    * 武器伤害绝对上限
    */
    public final ForgeConfigSpec.DoubleValue WEAPON_DAMAGE_MAX_CAP;

    public WeaponDamageCapConfig(ForgeConfigSpec.Builder builder) {

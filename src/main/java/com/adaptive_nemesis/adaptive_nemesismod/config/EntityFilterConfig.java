...
public class EntityFilterConfig {
     ...
     */
    public final ForgeConfigSpec.BooleanValue ENABLE_ENTITY_FILTER;

    /**
     * 实体黑名单 - 在黑名单中的实体不会被自适应系统缩放
     * 支持 * 通配符，例如：minecraft:zombie,minecraft:iron_golem,alexsmobs:*
     */
    public final ForgeConfigSpec.ConfigValue<String> ENTITY_BLACKLIST;

    public EntityFilterConfig(ForgeConfigSpec.Builder builder) {

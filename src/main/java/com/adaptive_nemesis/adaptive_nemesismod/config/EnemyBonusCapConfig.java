...
public class EnemyBonusCapConfig {
    ...
    * 是否启用敌人加成上限
    */
    public final ForgeConfigSpec.BooleanValue ENABLE_ENEMY_BONUS_CAP;

    /**
    * 血量加成上限倍率
    */
    public final ForgeConfigSpec.DoubleValue MAX_HEALTH_MULTIPLIER;

    /**
    * 伤害加成上限倍率
    */
    public final ForgeConfigSpec.DoubleValue MAX_DAMAGE_MULTIPLIER;

    /**
    * 护甲加成上限倍率
    */
    public final ForgeConfigSpec.DoubleValue MAX_ARMOR_MULTIPLIER;

    /**
    * 法术强度加成上限倍率
    */
    public final ForgeConfigSpec.DoubleValue MAX_SPELL_POWER_MULTIPLIER;

    /**
    * 法术抗性加成上限倍率
    */
    public final ForgeConfigSpec.DoubleValue MAX_SPELL_RESIST_MULTIPLIER;

    /**
    * 受击抗性加成上限倍率
    */
    public final ForgeConfigSpec.DoubleValue MAX_HIT_RESIST_MULTIPLIER;

    /**
    * 击倒抗性加成上限倍率
    */
    public final ForgeConfigSpec.DoubleValue MAX_KNOCKDOWN_RESIST_MULTIPLIER;

    /**
    * 耐力值加成上限倍率
    */
    public final ForgeConfigSpec.DoubleValue MAX_STAMINA_MULTIPLIER;

    public EnemyBonusCapConfig(ForgeConfigSpec.Builder builder) {
